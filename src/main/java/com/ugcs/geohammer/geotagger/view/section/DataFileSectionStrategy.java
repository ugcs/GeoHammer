...
import com.ugcs.geohammer.geotagger.view.FileSectionPanel;
...
public class DataFileSectionStrategy implements FileSectionStrategy{
	...
	public DataFileSectionStrategy(Supplier<Window> stage, SgyFileInfoExtractor sgyFileInfoExtractor, FileSectionPanel positionPanel) {
	...
	private String calculateCoverageStatus(SgyFile file) {
		List<SgyFile> positionFiles = positionPanel.getFiles();
